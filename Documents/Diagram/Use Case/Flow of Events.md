...
3.	Приложение предоставляет пользователю возможные варианты дальнейших действий: [удалить задачу](#delete_task), [редактировать задачу](#edit task), [отметить выполненные дела](#mark task);
